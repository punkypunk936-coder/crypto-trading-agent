...
CATEGORY_SEGMENTS = {
    ...
    "ai_chips": "AI Chips",
    "foundries_fab": "Foundries & Fab",
    "memory_storage": "Memory & Storage",
    "hyperscalers": "Hyperscalers",
    "servers_racks": "Servers & Racks",
...
SEGMENT_THESES = {
    ...
    "AI Chips": "Accelerator and silicon demand leads the AI compute cycle; orders, supply, and margins decide durability.",
    "Foundries & Fab": "Utilization and equipment orders confirm whether chip demand is becoming real manufacturing spend.",
    "Servers & Racks": "System vendors show when components are turning into deployable racks and complete AI clusters.",
    "Networking & Optics": "Switching, interconnect, and optics must scale with cluster size for compute demand to remain useful.",
    "Power & Cooling": "Power delivery and thermal capacity are physical constraints on data-center deployment.",
    "Data Centers": "Powered capacity, leasing, and development pipelines measure the physical AI buildout.",
...
NAME_THESES = {
    ...
    "DELL": "Dell is an AI server and rack-deployment read-through; orders and backlog must convert without crushing margins.",
    "HPE": "HPE is an enterprise AI systems read-through; server orders, networking, and margin conversion decide follow-through.",
    "VRT": "Vertiv is the cooling and power bottleneck trade; backlog and capacity expansion anchor the thesis.",
    "ANET": "Arista is the AI cluster networking read-through; cloud capex and high-speed switching demand must confirm.",
}
