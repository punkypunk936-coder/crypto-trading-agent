...
class TradingConfig:
    ...
    base_leverage: int            = 2
    max_leverage: int             = 8
    starter_max_leverage: int     = 3
    event_starter_max_leverage: int = 4
    scale_in_max_leverage: int    = 4
    scalp_max_leverage: int       = 4
    starter_min_leverage: int     = 2
    event_starter_min_leverage: int = 3
    scalp_min_leverage: int       = 2
    high_conviction_min_leverage: int = 3
    extreme_conviction_min_leverage: int = 4
    conviction_leverage_floor_overrides_clarity_cap: bool = True
    ...
    win_rate_recovery_min_flow_score: float = 58.0
    win_rate_recovery_min_sequence_score: float = 66.0
    win_rate_recovery_critical_min_sequence_score: float = 70.0
    win_rate_recovery_min_probability: float = 0.58
    win_rate_recovery_critical_min_probability: float = 0.61
    win_rate_recovery_event_min_probability: float = 0.55
    win_rate_recovery_min_expected_r: float = 0.18
    win_rate_recovery_max_uncertainty: float = 0.46
    win_rate_recovery_min_social_attention_score: float = 64.0
    win_rate_recovery_min_social_mentions: int = 2
    win_rate_recovery_event_score: float = 2.75
    win_rate_recovery_catalyst_score: float = 3.0
    ...
    similar_trade_memory_enabled: bool = True
    similar_trade_min_similarity: float = 0.62
    similar_trade_hard_block_loss_pct: float = 0.75
    similar_trade_haircut_loss_pct: float = 0.25
    similar_trade_size_multiplier: float = 0.50
    win_rate_guard_enabled: bool = True
    win_rate_guard_cache_seconds: float = 180.0
    win_rate_guard_history_limit: int = 300
    win_rate_guard_target_quality_win_rate: float = 0.70
    win_rate_guard_min_history_trades: int = 10
    win_rate_guard_min_family_samples: int = 3
    win_rate_guard_toxic_family_win_rate: float = 0.40
    win_rate_guard_trim_family_win_rate: float = 0.55
    win_rate_guard_size_multiplier: float = 0.45
    win_rate_guard_recent_loss_window: int = 6
    win_rate_guard_recent_loss_limit: int = 3
    win_rate_guard_min_probability: float = 0.58
    win_rate_guard_min_expected_r: float = 0.20
    win_rate_guard_max_uncertainty: float = 0.44
    win_rate_guard_min_execution_quality: float = 68.0
    win_rate_guard_min_thesis_quality: str = "MEDIUM"
    win_rate_guard_strict_min_probability: float = 0.62
    win_rate_guard_strict_min_expected_r: float = 0.26
    win_rate_guard_strict_max_uncertainty: float = 0.38
    win_rate_guard_strict_min_execution_quality: float = 74.0
    win_rate_guard_strict_min_thesis_quality: str = "HIGH"
    win_rate_guard_event_min_probability: float = 0.54
    win_rate_guard_event_min_expected_r: float = 0.12
    win_rate_guard_event_max_uncertainty: float = 0.58
    win_rate_guard_event_min_thesis_quality: str = "MEDIUM"
    win_rate_guard_event_size_multiplier: float = 0.60
    win_rate_guard_min_analog_samples: int = 4
    win_rate_guard_min_analog_win_rate: float = 0.55
    crypto_structure_sentiment_enabled: bool = True
    crypto_drawdown_long_dampener: float = 0.35
    crypto_drawdown_short_bias_boost: float = 5.0
    crypto_drawdown_long_score_cap: float = 52.0
    crypto_risk_off_long_score_cap: float = 58.0
    crypto_drawdown_entry_guard_enabled: bool = True
    crypto_drawdown_block_longs_without_reclaim: bool = True
    crypto_drawdown_long_min_probability: float = 0.64
    crypto_drawdown_long_min_expected_r: float = 0.30
    crypto_risk_off_long_size_multiplier: float = 0.55
    ...
    scalp_score_buffer: float = 8.0
    scalp_probe_from_flat_enabled: bool = True
    scalp_probe_min_edge_points: float = 1.0
