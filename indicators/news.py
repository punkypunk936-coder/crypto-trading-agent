...
MACRO_NEWS_QUERIES: Dict[str, str] = {
    ...
    "JP225": "Nikkei 225 OR Japan stocks OR Tokyo market OR Japanese exporters OR Bank of Japan",
    "EWJ": "EWJ OR Japan ETF OR Nikkei OR Japanese equities OR yen exporters",
...
ASSET_NEWS_PROFILES: Dict[str, Dict[str, List[str]]] = {
    ...
    "KR200": {
        "primary": ["kospi", "kospi 200", "south korea stocks"],
        "context": ["samsung", "sk hynix", "memory", "semiconductors", "exports", "korean won"],
        "strong_context": ["samsung", "sk hynix", "memory", "semiconductor exports"],
    },
    "JP225": {
        "primary": ["nikkei", "nikkei 225", "japan stocks"],
        "context": ["tokyo market", "japanese exporters", "bank of japan", "yen"],
        "strong_context": ["nikkei", "exporters", "bank of japan", "yen"],
    },
    "EWJ": {
        "primary": ["ewj", "japan etf"],
        "context": ["nikkei", "japanese equities", "exporters", "bank of japan", "yen"],
        "strong_context": ["nikkei", "exporters", "bank of japan", "yen"],
    },
